 ...
 * No Azure Function or Express dependencies — can be unit-tested independently.
 *
 * @param {object} opts
 ...
 */
export async function processAdoWebhook({ body, googleChatWebhookUrl, targetAreaPath, log }) {
